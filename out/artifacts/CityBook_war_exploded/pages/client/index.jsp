	...
	<Script type="text/javascript">
		$(function () {
			...
			$("button.addToCart").click(function () {
				...
				// location.href = "http://localhost:8080/CityBook/cartServlet?action=addItem&id=" + bookId;

				// 发ajax请求，添加商品到购物车
				$.getJSON("http://localhost:8080/CityBook/cartServlet","action=ajaxAddItem&id=" + bookId,function (data) {
